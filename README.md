...
- **[AdaBoost_certificate/](AdaBoost_certificate/)** — Computational certificate (exact rational arithmetic, no floating point)
...
```bash
cd AdaBoost_certificate
python adaboost_cert_full.py
```

See [cert_readme.md](AdaBoost_certificate/cert_readme.md) for details.
